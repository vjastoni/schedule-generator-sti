...
const AddSchedule = (props) => {
  ...
  const handleMeeting = async () => {
    if (!disabled) {
      const startHour = document.getElementById('startHour').value ?? '12';
      const startMin = document.getElementById('startMin').value ?? '00';
      const startType = document.getElementById('startType').value ?? 'AM';
      const endHour = document.getElementById('endHour').value ?? '12';
      const endMin = document.getElementById('endMin').value ?? '00';
      const endType = document.getElementById('endType').value ?? 'AM';
